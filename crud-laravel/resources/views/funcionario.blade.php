...
<body class="bg-gray-900 text-white">
    ...
    margin-right: auto; margin-top: 20px">Lista de Funcionários</h1>

                @if(session('success'))
                <div id="success-alert" class="success-alert">
                    <span>{{ session('success') }}</span>
                    <button onclick="document.getElementById('success-alert').style.display='none'" class="close-btn">
                        &times;
                    </button>
                </div>
                @endif
                ...
                <div class="table-container" style="max-width: 90%; margin-left: auto; margin-right: auto;">
                    <table class="table table-striped custom-table" style="margin-bottom: 50px;">
                        <thead>
                            <tr>
                                <th>Foto</th>
                                <th>Nome</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $funcionario->caminho_barbearia }}</td>
                                <td>{{ $funcionario->frase_pessoal }}</td>
                                <td>
                                    <a href="{{ route('funcionarios.edit', $funcionario->id) }}" class="btn btn-edit">Editar</a> |
                ...
                @else
                <p class="no-agendamentos-message">Nenhum funcionário cadastrado.</p>
                @endif
            </div>
        </div>
    </div>
