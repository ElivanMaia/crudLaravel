    ...
    <div class="container-fluid">
                ...
                <div class="form-container">
                    ...
                    <form action="{{ route('funcionarios.update', $funcionario->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="caminho_barbearia" id="caminho_barbearia" rows="4" class="form-control" required>{{ $funcionario->caminho_barbearia }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="frase_pessoal" id="frase_pessoal" rows="2" class="form-control">{{ $funcionario->frase_pessoal }}</textarea>
                        </div>

                        <div class="text-center">
                            <button type="submit" class="btn btn-warning w-100">Atualizar Funcionário</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <script>
            function confirmUpdate() {
                return confirm("Você tem certeza que deseja atualizar os dados deste funcionário?");
            }
        </script>
</body>
