...
<body class="bg-gray-900 text-white">
    ...
    margin-right: auto; margin-top: 20px">Lista de Feedbacks</h1>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @for ($i = 1; $i <= 5; $i++)
                                        <span class="bi {{ $i <= $feedback->avaliacao ? 'bi-star-fill' : 'bi-star' }}" style="font-size: 20px; color: {{ $i <= $feedback->avaliacao ? 'yellow' : 'gray' }};"></span>
                                        @endfor
                                </td>

                                <td>{{ $feedback->mensagem }}</td>

                                <td>{{ $feedback->sugestoes ?? 'Nenhuma sugestão' }}</td>
                ...
                @else
                <p class="no-agendamentos-message">Nenhum feedback encontrado.</p>
                @endif
            </div>
        </div>
    </div>
